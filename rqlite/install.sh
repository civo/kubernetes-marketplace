...
helm upgrade -n rqlite --create-namespace rqlite --install rqlite/rqlite --version 1.3.1 && echo "Civo installed rqlite helm chart, Done" || echo "error installing rqlite helm chart"
